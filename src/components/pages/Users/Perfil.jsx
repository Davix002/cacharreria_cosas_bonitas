...
function Perfil() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      <form
        className="w-full max-w-md p-6 bg-white rounded-xl shadow-lg mb-4"
      ...
      >
        ...
        <div className="mt-4">
          ...
          <p>
            <strong>Código postal:</strong> {usuario.postalCode}
          </p>
          <p>
            <strong>Telefono:</strong> {usuario.phone}
          </p>
          <p>
            <strong>Tarjeta de credito: **** **** **** </strong> {usuario.creditCardNumber.slice(-4)}
          </p>
          {!usuario.address && (
            <input
              type="text"
          ...
          {!usuario.phone &&(<input
            ...
            className="my-2 p-2 border rounded"
          />)}
          {!usuario.creditCardNumber &&(<input
            type="text"
