    ...
    <>
      <section className="flex w-full h-screen">
        <div className="flex flex-col justify-center  w-full p-8 bg-gray-100  lg:px-12 xl:px-32 lg:w-1/2">
          ...
          <div className="mt-6 md:mt-8 w-full flex items-center justify-center lg:w-1/2">
          ...
          <form>
            ...
            <div className="w-full mt-4">
              ...
              <textarea
                ...
                placeholder="Cuentenos el motivo de consulta"
              ></textarea>
            </div>

            <button className="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-romTurquoise-500 rounded-md hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
              Enviar inquitud
            </button>
          </form>
        </div>
